enrollModule.controller('CustomerSummaryCtrl', ['$scope', '$ionicLoading', 'UiUtil', 'User', function($scope, $ionicLoading, UiUtil, User){
	// private properties -------------------------------------------------------------
	var address = '';
	...
	var preferredStore = address + ' ' + currentStore.City + ', ' + currentStore.State + ' ' + currentStore.Zipcode
	// scope properties -------------------------------------------------------------
	// public properties -------------------------------------------------------------
	$scope.preferredStore = preferredStore;
	...
	$scope.createUser = function(){
		$ionicLoading.show();
		//$scope.enrollInfo.Address = address;
		//$scope.enrollInfo.City = currentStore.City;
		//$scope.enrollInfo.State = currentStore.State;
		//$scope.enrollInfo.ZipCode = currentStore.Zipcode;
